...
-- --------------------------------------------------
-- Date Created: 10/27/2013 19:28:51
-- Generated from EDMX file: D:\root\yura\institute\!!!_asp_net_mvc\linq\LINQ_2\!!!_SimpleLINQ\EntityLINQ\LearningModel.edmx
-- --------------------------------------------------
...
ADD CONSTRAINT [PK_StudentGroupSubject]
    PRIMARY KEY NONCLUSTERED ([StudentGroup_Id], [Subject_Id] ASC);
GO
